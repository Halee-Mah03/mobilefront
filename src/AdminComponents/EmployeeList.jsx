          ...
          <tbody className='bg-white divide-y divide-gray-600 whitespace-nowrap'>
            {
              employee.map(e => (
                <tr className='even:bg-blue-50'>
                  <td className='p-4 text-sm text-black'>{e.FirstName}</td>
                  <td className='p-4 text-sm text-black'>{e.LastName}</td>
                  <td className='p-4 text-sm text-black'>{e.Email}</td>
                  <td className='p-4 text-sm text-black'>{e.Salary}</td>
                  <td className='p-4 text-sm text-black'>{e.Department}</td>
                  <td className='py-4 text-sm text-gray-800'>
                    <div className=' w-max bg-white-900 border-2 flex overflow-hidden mx-auto'>
                    <button onClick={() => {navigate('/ad_dashboard/edit_employee/' +e.id)}} className=" px-3 py-2 flex items-center text-sm outline-none">
<svg xmlns="http://www.w3.org/2000/svg" width="20px" fill="currentColor" className="w-6 hover:fill-gray-700" viewBox="0 0 24 24">
...
<button className="text-red-600 px-3 py-2 flex items-center text-sm  outline-none" onClick={() => handleClick(e.id)}>
