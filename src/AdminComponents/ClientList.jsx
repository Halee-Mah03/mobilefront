      ...
      <div className='font-[sans-serif] overflow-x-auto'>
        <table className='min-w-full divide-y divide-gray-600'>
          <thead className="bg-gray-900 text-white whitespace-nowrap">
            <tr><th className="p-4 text-left text-sm font-medium text-blue">Client ID</th>
          ...
          <tbody className='bg-white divide-y divide-gray-600 whitespace-nowrap'>
            {
             data.map(client => (
              <tr key={client.id} className='even:bg-blue-50'>
                <td className='p-4 text-sm text-black'>{client.id}</td>
                  ...
                  <td className='py-4 text-sm text-gray-800'>
                    ...
                    <button onClick={() => {navigate(`/ad_dashboard/edit_client/${client.id}`)}} 
                    className=" px-3 py-2 flex items-center text-sm outline-none">
<svg xmlns="http://www.w3.org/2000/svg" width="20px" fill="currentColor" 
className="w-6 hover:fill-gray-700" viewBox="0 0 24 24">
...
className="text-red-600 px-3 py-2 flex items-center text-sm  outline-none"
 >
  ...
  className="w-6 fill-red-500 hover:fill-red-700" viewBox="0 0 24 24">
<path
