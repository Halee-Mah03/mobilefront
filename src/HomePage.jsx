...
const HomePage = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-gray-900 via-gray-700 to-gray-900 h-screen  p-9 flex flex-col justify-center font-[sans-serif] overflow-hidden">
      <div className="grid md:grid-cols-2 justify-center items-center max-md:text-center md:gap-8 gap-16 h-full">
        <div className="md:max-w-md mx-auto">
          ...
          <p className="text-white">We offer seamless and secured bank transactions</p>
          <div className="mt-7">
        ...
        <div className="md:text-right">
          <img src="https://media.istockphoto.com/id/640267784/photo/bank-building.jpg?s=612x612&w=0&k=20&c=UTtm4t6WR-MLwO6ATq5l6n3SoCc6HpaClEFZMxO1Nek=" alt="the bank" className="object-cover w-full" />
        </div>
      </div>
    </div>
  )
