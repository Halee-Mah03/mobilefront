    ...
    <div class="bg-gray-50 px-4 py-12 font-[sans-serif]">
        <div className="grid lg:grid-cols-3 md:grid-cols-2 max-md:max-w-lg mx-auto">
          <div className="p-6 flex gap-6 bg-white rounded-lg shadow-md hover:shadow-lg transition-all">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-12 h-12 bg-gray-100 p-3 rounded-md shrink-0" viewBox="0 0 682.667 682.667">
              <defs>
            ...
            <div>
              <h3 className="text-gray-800 text-xl font-semibold mb-3">BVN Authentication</h3>
          ...
          <div className="p-6 flex gap-6 bg-white rounded-lg shadow-md hover:shadow-lg transition-all">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-12 h-12 bg-gray-100 p-3 rounded-md shrink-0" viewBox="0 0 512.001 512.001">
          ...
          <div className="p-6 flex gap-6 bg-white rounded-lg shadow-md hover:shadow-lg transition-all">
            ...
            <div>
              <h3 className="text-gray-800 text-xl font-semibold mb-3">News</h3>
              <p className="text-gray-600 text-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos,delectus rerum voluptatibus a voluptates explicabo?</p>
            </div>
          </div>

          <div className="p-6 flex gap-6 bg-white rounded-lg shadow-md hover:shadow-lg transition-all">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-12 h-12 bg-gray-100 p-3 rounded-md shrink-0" viewBox="0 0 504.69 504.69">
            ...
            <div>
              <h3 className="text-gray-800 text-xl font-semibold mb-3">Transactions</h3>
              <p className="text-gray-600 text-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos,delectus rerum voluptatibus a voluptates explicabo?</p>
            </div>
          </div>
          ...
          <div className="p-6 flex gap-6 bg-white rounded-lg shadow-md hover:shadow-lg transition-all">
            ...
            <div>
              <h3 className="text-gray-800 text-xl font-semibold mb-3">Customize Links</h3>
              <p className="text-gray-600 text-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos,delectus rerum voluptatibus a voluptates explicabo?.</p>
            </div>
          </div>
          <div className="p-6 flex gap-6 bg-white rounded-lg shadow-md hover:shadow-lg transition-all">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-12 h-12 bg-gray-100 p-3 rounded-md shrink-0" viewBox="0 0 32 32">
            ...
            <div>
              <h3 className="text-gray-800 text-xl font-semibold mb-3">Settings</h3>
              <p className="text-gray-600 text-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos,delectus rerum voluptatibus a voluptates explicabo?</p>
            </div>
          </div>
